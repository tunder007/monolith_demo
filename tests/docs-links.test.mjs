...
const DOCS = [
  ...
  "CONTRIBUTING.md",
  "docs/README.md",
  "docs/layer-0-quickstart.md",
  "docs/layer-1-packages.md",
  "docs/layer-2-reference/README.md",
  "docs/layer-2-reference/config.md",
  "docs/layer-2-reference/env.md",
  "docs/layer-2-reference/db.md",
